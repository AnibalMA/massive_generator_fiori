		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Generador masivo Fiori Tiles &amp; TM",
									"targetURL": "#nttdatamassivegeneratorfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatamassivegeneratorfiori-display": {
								"semanticObject": "nttdatamassivegeneratorfiori",
								"action": "display",
								"description": "Generador masivo para la creación de Tiles &amp; TM",
								"title": "Generador masivo Fiori Tiles &amp; TM",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.massivegeneratorfiori",
									"url": sap.ui.require.toUrl("nttdata/massivegeneratorfiori")
								}
							}
						}
					}
